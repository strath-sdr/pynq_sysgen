...
################################################################
# This is a generated script based on design: audio_gain
#
...
strath.ac.uk:AXI_Stream:audio_gain:1.0\
...
proc create_root_design { parentCell } {
  ...
  set bclk [ create_bd_port -dir O -from 0 -to 0 -type data bclk ]
  set codec_addr [ create_bd_port -dir O -from 1 -to 0 codec_addr ]
  set lrclk [ create_bd_port -dir O -from 0 -to 0 -type data lrclk ]
  set sdata_i [ create_bd_port -dir I -from 0 -to 0 -type data sdata_i ]
  set_property -dict [ list \
  ...
  # Create instance: audio_codec_ctrl, and set properties
  set audio_codec_ctrl [ create_bd_cell -type ip -vlnv xilinx.com:user:audio_codec_ctrl:1.0 audio_codec_ctrl ]

  # Create instance: audio_gain, and set properties
  set audio_gain [ create_bd_cell -type ip -vlnv strath.ac.uk:AXI_Stream:audio_gain:1.0 audio_gain ]

  # Create instance: clk_wiz_10M, and set properties
  set clk_wiz_10M [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 clk_wiz_10M ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net processing_system7_IIC_1 [get_bd_intf_ports IIC_1] [get_bd_intf_pins processing_system7/IIC_1]
  ...
  connect_bd_intf_net -intf_net ps7_axi_periph_M00_AXI [get_bd_intf_pins audio_codec_ctrl/S_AXI] [get_bd_intf_pins ps7_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_axi_periph_M01_AXI [get_bd_intf_pins audio_gain/audio_gain_s_axi] [get_bd_intf_pins ps7_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net audio_codec_ctrl_bclk [get_bd_pins audio_codec_ctrl/bclk] [get_bd_pins audio_gain/bclk_in]
  connect_bd_net -net audio_codec_ctrl_codec_address [get_bd_ports codec_addr] [get_bd_pins audio_codec_ctrl/codec_address]
  connect_bd_net -net audio_codec_ctrl_lrclk [get_bd_pins audio_codec_ctrl/lrclk] [get_bd_pins audio_gain/lrclk_in]
  connect_bd_net -net audio_codec_ctrl_sdata_o [get_bd_ports sdata_o] [get_bd_pins audio_codec_ctrl/sdata_o]
  connect_bd_net -net audio_gain_bclk_out [get_bd_ports bclk] [get_bd_pins audio_gain/bclk_out]
  connect_bd_net -net audio_gain_lrclk_out [get_bd_ports lrclk] [get_bd_pins audio_gain/lrclk_out]
  connect_bd_net -net audio_gain_sdata_out [get_bd_pins audio_codec_ctrl/sdata_i] [get_bd_pins audio_gain/sdata_out]
  connect_bd_net -net clk_wiz_10M_clk_out1 [get_bd_ports audio_clk_10MHz] [get_bd_pins clk_wiz_10M/clk_out1]
  connect_bd_net -net processing_system7_FCLK_CLK0 [get_bd_pins audio_codec_ctrl/s_axi_aclk] [get_bd_pins audio_gain/clk] [get_bd_pins clk_wiz_10M/clk_in1] [get_bd_pins processing_system7/FCLK_CLK0] [get_bd_pins processing_system7/M_AXI_GP0_ACLK] [get_bd_pins ps7_axi_periph/ACLK] [get_bd_pins ps7_axi_periph/M00_ACLK] [get_bd_pins ps7_axi_periph/M01_ACLK] [get_bd_pins ps7_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_100M_peripheral_aresetn [get_bd_pins audio_codec_ctrl/s_axi_aresetn] [get_bd_pins audio_gain/audio_gain_aresetn] [get_bd_pins clk_wiz_10M/resetn] [get_bd_pins ps7_axi_periph/ARESETN] [get_bd_pins ps7_axi_periph/M00_ARESETN] [get_bd_pins ps7_axi_periph/M01_ARESETN] [get_bd_pins ps7_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_100M/peripheral_aresetn]
  connect_bd_net -net sdata_in_0_1 [get_bd_ports sdata_i] [get_bd_pins audio_gain/sdata_in]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7/Data] [get_bd_addr_segs audio_codec_ctrl/S_AXI/reg0] -force
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7/Data] [get_bd_addr_segs audio_gain/audio_gain_s_axi/reg0] -force
